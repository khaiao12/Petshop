...
function onLoad() {
  ...
  switch (idPage) {
    case "dog-food": {
      document.querySelector("h1").innerHTML = "Thức ăn cho chó";
      break;
    }
    case "dog": {
      document.querySelector("h1").innerHTML = "Các loai chó";
      break;
    }
    case "cat-food": {
      document.querySelector("h1").innerHTML = "Thức ăn cho mèo";
      break;
    }
    case "cat": {
      document.querySelector("h1").innerHTML = "Các loại mèo";
      break;
    }
    case "balo": {
